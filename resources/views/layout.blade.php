            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="vizewNav">
                        ...
                        <!-- Nav brand -->
                        <a href="{{url('/')}}" class="nav-brand text-white"><img src="{{asset('frontend/img/core-img/logo.png')}}"></a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="{{url('/')}}" class="foo-logo d-block mb-4">DigitalPens</a>
